...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/josephcaluya/QBIO490/qbio_490_josephcaluya")) 
```
...
# vector of strings
three_fav_colors <- c("lavender", "light blue", "taupe")
three_fav_colors
...
# prediction: it will print out D and E
```
