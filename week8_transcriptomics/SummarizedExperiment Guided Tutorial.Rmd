...
write.csv(rna_clinical, '/home1/jcaluya/490_cluster/analysis_data/BRCA_rna_clinical.csv')
...
write.csv(rna_genes, '/home1/jcaluya/490_cluster/analysis_data/BRCA_rna_genes.csv')
...
write.csv(rna_counts, '/home1/jcaluya/490_cluster/analysis_data/BRCA_rna_counts.csv')
rna_counts <- read.csv('/home1/jcaluya/490_cluster/analysis_data/BRCA_rna_counts.csv')
#apply mask from rna clinical to rna counts in columns, apply mask from rna genes to rna counts in rows
```
